...
@Module({
    ...
    providers: [UserService, VerificationService, CitizenMapper, VerificatorMapper, UsersRepository, UserRoleRepository, PointRepository, TrashRepository, VillageRepository, VerificationRepository],
})
